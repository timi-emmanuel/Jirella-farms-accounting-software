...
export default function CatfishJuvenileDashboardPage() {
  return (
    <div className="h-full flex flex-col space-y-6 overflow-y-auto modal-scrollbar">
      <div className="flex flex-col">
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">
          Catfish <span className="text-emerald-600">Juvenile Management</span>
        </h1>
      ...
      <div className="flex gap-3 flex-wrap">
        <Link href="/catfish/juvenile/inventory">
          <Button className="bg-emerald-600 hover:bg-emerald-700 text-white">
            <Package2 className="w-4 h-4 mr-2" />
            Feed Inventory
          </Button>
        </Link>
        <Link href="/catfish/juvenile/expenses">
          <Button className="bg-orange-600 hover:bg-orange-700 text-white">
            <Receipt className="w-4 h-4 mr-2" />
            External Expenses
          </Button>
        </Link>
        <Link href="/catfish/juvenile">
      ...
      <div className="flex flex-col">
        ...
        <CatfishStageDashboard stage="juvenile" />
      </div>
    </div>
  );
}
