...
export default function CatfishJuvenilePage() {
  return (
    <div className="h-full flex flex-col space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex flex-col">
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">
            Catfish <span className="text-emerald-600">Juvenile Batch Operations</span>
          </h1>
          <p className="text-slate-500 text-sm font-medium">
            Manage juvenile batches and track production.
          </p>
      ...
      <CatfishBatchGrid productionType="Juvenile" basePath="/catfish/juvenile" stageLabel="Juvenile" />
    </div>
  );
}
